import { useState, useEffect, useReducer, useDeferredValue, useCallback, memo } from 'react';
import './style.css';
...
const HistoryList = memo(function HistoryList({ history, currentMove, jumpTo }) {
...
const Board = memo(function Board({ history, currentMove, onPlay, autoPlay }) {
